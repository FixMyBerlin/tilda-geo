...
| [add-db-data-table](.cursor/skills/add-db-data-table/SKILL.md) | Postgres `data.*` tables via `data-schema/` (spec, data-schema-load, data-schema-publish, `/admin/data-schema`) — not map StaticDatasets |
