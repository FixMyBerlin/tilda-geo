  ...
  atlas_bikelanes: {
    keys: {
      ...
      era_width_confidence:
        'Beruht die Bewertung auf einer angenommenen Verkehrsrichtung, ist sie nur „vermutlich“ richtig. Angenommen ist die Richtung, wenn sie nicht aus einem OSM-Tag stammt, sondern aus der Führungsform abgeleitet (`implicit_yes`) oder geschätzt wurde (`assumed_no`).',
      era_width_used:
    ...
    values: {
      ...
      era_width_confidence: {
        ...
        low: 'Die Verkehrsrichtung ist angenommen. Trifft die Annahme nicht zu, gilt ein anderes Regelmaß und die Bewertung kann kippen.',
      },
      oneway: {
        assumed_no:
