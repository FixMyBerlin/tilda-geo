...
/* prettier-ignore */
export const translationsAtlasAndAll = {
  ...
  'ALL--category=cyclewayOnHighwayProtected': 'Geschützter Radfahrstreifen (Protected Bike Lane / PBL)',
  ...
  'ALL--category=footwayBicycleYes_adjoining': 'Gehweg mit "Radfahrer frei", straßenbegleitend',
  'ALL--category=footwayBicycleYes_adjoiningOrIsolated': 'Gehweg mit "Radfahrer frei" (Straßenbegleitend oder selbstständig geführt; Kategorisierung unklar)',
  'ALL--category=footwayBicycleYes_isolated': 'Gehweg mit "Radfahrer frei", selbstständig geführt',
  ...
  'ALL--highway=motorway_link': 'Zufahrt einer Autobahn',
  'ALL--highway=motorway': 'Autobahn',
  'ALL--highway=path': 'Weg / Pfad',
  'ALL--highway=pedestrian': 'Fußgängerzone',
  'ALL--highway=primary_link': 'Zufahrt einer Bundesstraße/Hauptverbindungsstraße',
  ...
  'ALL--highway=tertiary_link': 'Zufahrt einer Kreisstraße/untergeordneten Durchgangsstraße',
  ...
  'ALL--length--description': 'Ein berechneter Wert für as OpenStreetMap-Straßensegment. Die Berechnung nutzt die Projektion EPSG:5243 und hat somit eine gute Genaugikeit für Deutschland.',
  ...
  'ALL--smoothness_source=mtb:scale_to_smoothness': 'Abgeleitet von dem OSM Wert `mtb:scale`',
  'ALL--smoothness_source=parent_highway_tag': 'OSM-Tag `smoothness` der zugeordneten Straße',
  'ALL--smoothness_source=surface_to_smoothness': 'Abgeleitet von dem Wert der Oberfläche über Standard-Werte',
  'ALL--smoothness_source=tag': 'OSM-Tag `smoothness`',
  'ALL--smoothness_source=tracktype_to_smoothness': 'Abgeleitet von dem OSM Wert `tracktype`',
  ...
  'ALL--surface_color--key': 'Oberflächenfarbe',
  'ALL--surface_color=green': 'Grün',
  'ALL--surface_color=no': 'Keine besondere Farbe (explizit)',
  'ALL--surface_color=red': 'Rot',
  'ALL--surface_source=parent_highway_tag': 'OSM-Tag `surface` der zugeordneten Straße',
  'ALL--surface_source=tag': 'OSM-Tag `surface`',
  'ALL--surface=asphalt': 'Asphalt',
  'ALL--surface=bricks': 'Ziegelsteine',
  'ALL--surface=cobblestone': 'Kopfsteinpflaster',
  'ALL--surface=compacted': 'Verdichtete Deckschicht',
  'ALL--surface=concrete:lanes': 'Betonplatten-Spuren',
  ...
  'ALL--surface=large_sett': 'Großsteinpflaster',
  'ALL--surface=metal_grid': 'Metallgitter',
  'ALL--surface=metal': 'Metall',
  'ALL--surface=mosaic_sett': 'Mosaikpflaster',
  'ALL--surface=paved': 'Versiegelte Oberfläche (unspezifisch)',
  'ALL--surface=paving_stones:lanes': 'Verbundpflastersteine-Spuren',
  'ALL--surface=paving_stones': 'Verbundpflastersteine',
  'ALL--surface=pebblestone': 'Kies',
  'ALL--surface=plastic': 'Kunststoff',
  'ALL--surface=rubber': 'Gummi',
  'ALL--surface=sand': 'Sand',
  'ALL--surface=sett': 'Behauenes Steinpflaster (Kopfsteinpflaster)',
  'ALL--surface=small_sett': 'Kleinsteinpflaster',
  'ALL--surface=stone': 'Stein',
  'ALL--surface=unpaved': 'Unbefestigt (unspezifisch)',
  'ALL--surface=wood': 'Holz',
  'ALL--surface=woodchips': 'Holzhackschnitzel',
  ...
  'atlas_roads--bikelane_SIDE=assumed_no--description': 'Wir erwarten hier keine Infrastruktur. Sollte es eine geben, kann diese natürlich eingetragen werden. Hintergrund: Bei Hauptstraßen wo eine Seite angegeben aber die andere fehlt, treffen wir die Annahme, dass die andere Seite keinen Radweg hat.',
  'atlas_roads--bikelane_SIDE=assumed_no': 'Vermutlich vollständig',
  'atlas_roads--bikelane_SIDE=data_no--description': 'In OSM wurde angegeben, dass keine Radinfrastruktur vorliegt.',
  'atlas_roads--bikelane_SIDE=data_no': 'Vollständig (explizit "keine")',
  'atlas_roads--bikelane_SIDE=data_present--description': 'In OSM wurde wurde Radinfrastruktur angegeben:',
  'atlas_roads--bikelane_SIDE=data_present': 'Vollständig (explizit)',
  'atlas_roads--bikelane_SIDE=missing--description': 'Wir konnten keine Infrastruktur erkennen.',
  'atlas_roads--bikelane_SIDE=missing': 'Unvollständig',
  'atlas_roads--bikelane_SIDE=not_expected--description': 'Wir erwarten hier keine Infrastruktur, zum Beispiel an der innenseite einer Straße die in zwei Geometrien erfasst ist oder bei bestimmten Straßentypen wenn explizite Angaben zur Radinfrastruktur pro Seite vorliegen.',
