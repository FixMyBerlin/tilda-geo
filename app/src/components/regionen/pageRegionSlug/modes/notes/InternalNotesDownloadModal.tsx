...
import { modePanelHeaderIconButtonClassName } from '@/components/regionen/pageRegionSlug/modes/modePanel.const'
...
export const InternalNotesDownloadModal = () => {
  ...
  return (
    <IconModal
      ...
      titleIcon="download"
      mode="notes"
      triggerStyle={modePanelHeaderIconButtonClassName}
      triggerIcon={
        <>
