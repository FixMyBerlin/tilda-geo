...
export const NavigationContactButton = ({ className }: Props) => {
  return (
    <a
      ...
      className={twMerge(
        'group inline-flex items-center justify-center gap-1 rounded-md border border-transparent bg-brand px-2.5 py-2 font-medium whitespace-nowrap text-gray-900 transition-colors hover:bg-brand/80 focus:ring-2 focus:ring-white focus:outline-none focus:ring-inset',
        className,
      )}
    >
