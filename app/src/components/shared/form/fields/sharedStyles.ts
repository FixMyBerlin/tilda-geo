...
export const inputBase =
  'block w-full appearance-none rounded-md border px-3 py-2 text-base shadow-sm focus:outline-none sm:text-sm disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:opacity-60'
