...
const outputFile = path.join(
  import.meta.dir,
  '../../src/regionen/[regionSlug]/_mapData/mapDataSources/sourcesBackgroundRasterELI.const.ts',
)
...
import { MapDataBackgroundSource } from '@/components/regionen/pageRegionSlug/mapData/types'
