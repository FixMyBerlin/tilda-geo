...
- Use `bun run mailpreview` to preview the template
...
Inside [`sendMail()`](./utils/sendMail.tsx) we use [React Mail `render`](https://react.email/docs/utilities/render#render) to create the HTML version of the mails.
