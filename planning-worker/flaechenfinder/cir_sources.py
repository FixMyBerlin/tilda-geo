...
def resolve_source(key: str, study_area_geom: BaseGeometry) -> CirSource | None:
    ...
    „auto" erkennt anhand des Studiengebiet-Zentroiden (12°E = UTM-Zonengrenze 32/33):
      < 12°E → Bayern (EPSG:25832); ≥ 12°E → Brandenburg/Berlin (EPSG:25833).
    ...
    if key == "auto":
        try:
            lon = study_area_geom.centroid.x
