...
package.path = package.path .. ";/processing/topics/barriers/helper/?.lua"
package.path = package.path .. ";/processing/topics/bicycleParking/?.lua"
package.path = package.path .. ";/processing/topics/bicycleParking/helper/?.lua"
package.path = package.path .. ";/processing/topics/bikeroutes/?.lua"
package.path = package.path .. ";/processing/topics/bikeroutes/helper/?.lua"
package.path = package.path .. ";/processing/topics/boundaries/?.lua"
package.path = package.path .. ";/processing/topics/boundaries/helper/?.lua"
package.path = package.path .. ";/processing/topics/helper/?.lua"
package.path = package.path .. ";/processing/topics/landuse/?.lua"
package.path = package.path .. ";/processing/topics/landuse/helper/?.lua"
package.path = package.path .. ";/processing/topics/parking/?.lua"
package.path = package.path .. ";/processing/topics/parking/crossings/?.lua"
package.path = package.path .. ";/processing/topics/parking/crossings/helper/?.lua"
...
package.path = package.path .. ";/processing/topics/parking/public_transport/platforms/?.lua"
package.path = package.path .. ";/processing/topics/parking/public_transport/stops/?.lua"
package.path = package.path .. ";/processing/topics/parking/public_transport/stops/helper/?.lua"
...
package.path = package.path .. ";/processing/topics/parking/separate_parkings/?.lua"
package.path = package.path .. ";/processing/topics/parking/separate_parkings/area/?.lua"
package.path = package.path .. ";/processing/topics/parking/separate_parkings/helper/?.lua"
package.path = package.path .. ";/processing/topics/parking/separate_parkings/point/?.lua"
package.path = package.path .. ";/processing/topics/places/?.lua"
package.path = package.path .. ";/processing/topics/places/helper/?.lua"
package.path = package.path .. ";/processing/topics/poiClassification/?.lua"
package.path = package.path .. ";/processing/topics/poiClassification/helper/?.lua"
package.path = package.path .. ";/processing/topics/publicTransport/?.lua"
package.path = package.path .. ";/processing/topics/publicTransport/helper/?.lua"
...
package.path = package.path .. ";/processing/topics/roads_bikelanes/pseudo_tags/?.lua"
package.path = package.path .. ";/processing/topics/roads_bikelanes/pseudo_tags_mapillary_coverage/?.lua"
package.path = package.path .. ";/processing/topics/roads_bikelanes/pseudo_tags_sidepath/?.lua"
...
package.path = package.path .. ";/processing/topics/trafficSigns/helper/?.lua"
