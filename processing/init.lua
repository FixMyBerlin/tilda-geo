...
package.path = package.path .. ";/processing/topics/helper/pseudo_tags/?.lua"
...
package.path = package.path .. ";/processing/topics/parking/obstacles_unprojected/?.lua"
package.path = package.path .. ";/processing/topics/parking/obstacles_unprojected/point/?.lua"
