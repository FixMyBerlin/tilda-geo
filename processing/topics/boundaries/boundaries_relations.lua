...
local LOG_ERROR = require('boundaries_errors')
local result_tags_boundaries = require('result_tags_boundaries')
...
local function boundaries_relations(object)
  ...
  local cleaned_tags, replaced_tags = result_tags_boundaries(tags)
