...
require('Clone')
require('Log')
require('obstacle_unprojected_point_categories')
...
local function categorize_unprojected_points(object)
  ---@type number
  local max_buffer = -1
  ...
  for _, category in ipairs(obstacle_unprojected_point_categories) do
...
return categorize_unprojected_points
