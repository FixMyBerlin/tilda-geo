...
local function paths_generalization(original_tags, result_tags)
  ...
  if original_tags.highway == 'track' and not SET.set({ 'grade1', 'grade2' })[original_tags.tracktype] then
    return 11
  end
  return 0
end

return paths_generalization
