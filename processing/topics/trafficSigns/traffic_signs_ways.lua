...
local exit_processing_traffic_sign_ways = require('exit_processing_traffic_sign_ways')
...
---@param object table
local function traffic_signs_ways(object)
  if exit_processing_traffic_sign_ways(object) then
    return
  end
